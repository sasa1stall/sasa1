...
const InventoryManager = () => {
    ...
    const [variants, setVariants] = useState<{weight: string, price: number, stock: number}[]>([{weight: '', price: 0, stock: 0}]);
    ...
    const addVariant = () => {
        setVariants([...variants, { weight: '', price: 0, stock: 0}]);
    };
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <select className="p-2 border rounded dark:bg-gray-800 dark:text-white dark:border-gray-600" value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})}>
                                <option>Chicken</option><option>Mutton</option><option>Seafood</option><option>Eggs</option>
                            </select>
                        </div>
                        ...
                        <input placeholder="Image URL" className="w-full p-2 border rounded dark:bg-gray-800 dark:text-white dark:border-gray-600" value={formData.image} onChange={e => setFormData({...formData, image: e.target.value})} required />
                        ...
                        <div className="space-y-2">
                            ...
                            {variants.map((v, i) => (
                                <div key={i} className="flex gap-2">
                                    ...
                                    <input type="number" placeholder="Price" className="p-2 border rounded w-24 dark:bg-gray-800 dark:text-white dark:border-gray-600" value={v.price} onChange={e => updateVariant(i, 'price', Number(e.target.value))} required />
                                    <input type="number" placeholder="Stock" className="p-2 border rounded w-24 dark:bg-gray-800 dark:text-white dark:border-gray-600" value={v.stock} onChange={e => updateVariant(i, 'stock', Number(e.target.value))} required />
                        ...
                        <div className="flex justify-end gap-2">
                             <button type="button" onClick={() => setIsFormOpen(false)} className="px-4 py-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 rounded">Cancel</button>
