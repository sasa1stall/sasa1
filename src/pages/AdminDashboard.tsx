          ...
          <button
            ...
            className={clsx(
              ...
              activeTab === "orders"
                ...
                : "bg-white dark:bg-dark-card text-gray-700 dark:text-gray-300 hover:bg-gray-100"
            )}
          >
            Orders
          </button>
    ...
    <div>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              {variants.map((v, i) => (
                <div key={i} className="flex gap-2">
                  ...
                  <input
                    ...
                    placeholder="Price"
                    min="0"
                    className="p-2 border rounded w-24 dark:bg-gray-800 dark:text-white dark:border-gray-600"
                    value={v.price}
            ...
            <div className="flex justify-end gap-2">
              <button
                ...
                className="px-4 py-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 rounded"
              >
                Cancel
              </button>
              <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((product) => (
          <div
            key={product._id}
            className="bg-white dark:bg-dark-card p-4 rounded-xl shadow-sm border border-gray-100 dark:border-dark-border flex space-x-4"
          >
            <img
              src={product.image}
